...
export class DefaultOfferService implements OfferService {
  ...
  public async create(dto: CreateOfferDto): Promise<DocumentType<OfferEntity>> {
    ...
    offer.postDate = dto.postDate || new Date();
    offer.city = dto.city;
    offer.previewImage = dto.previewImage;
    offer.images = dto.images;
    offer.isPremium = dto.isPremium || false;
    offer.isFavorite = dto.isFavorite || false;
    offer.rating = dto.rating || 0;
    offer.type = dto.type;
    offer.rooms = dto.rooms;
    offer.guests = dto.guests;
